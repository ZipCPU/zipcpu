...
%% {{{
% Revision History
3.0 & 6/18/2022 & Gisselquist & New debug interface, multi-bus support\\\hline
...
3 & R/W & Overflow flag.  The last ALU operation produced an arithmetic overflow.\\\hline
...
7--5 & & (Reserved)\\\hline
4 & WO & Clear cache.  Set to `1' to clear the CPU's caches.
...
2 & WO & Step Command.  Set to `1' to step the CPU, and then leave it halted.  Self clearing.\\\hline
1 & RO & Halt status.  If true, the CPU has halted.\\\hline
...
\end{itemize}
%% }}}
\appendix{Clocks}\label{chap:clocks}
%% {{{
...
%% }}}
\appendix{Wishbone Datasheets}\label{chap:wishbone}
%% {{{
