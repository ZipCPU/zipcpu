...
- The CPU makes heavy use of pipelined wishbone processing wherever and whenever it can.  Hence, loading two values in a row may cost only one clock more than just loading the one value.
